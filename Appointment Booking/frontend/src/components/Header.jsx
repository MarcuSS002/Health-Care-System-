...
const Header = () => {
    return (
        <div className='flex flex-col md:flex-row flex-wrap px-6 bg-primary rounded-lg md:px-10 lg:px-20'>
            {/* ---------Left Side -------- */}
            <div className='md:w-1/2 flex flex-col items-start justify-center py-10 gap-4 m-auto md:py-[10vw] md:mb-[-30px]'>
                ...
                <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
                    ...
                    <p>
                        Simply browse through our extensive list of trusted doctors, <br className='hidden sm:block' /> schedule your appointment
                    </p>
                </div>
