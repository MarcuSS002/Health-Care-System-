...
const MyProfile = () => {
  ...
  return userData && (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      {
        isEdit ?
          <input onChange={(e) => setUserData(prev => ({...prev, name: e.target.value}))} className='bg-gray-50 text-xl font-medium max-w-60 mt-4' type="text" value={userData.name} />
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
            isEdit ?
              <input onChange={(e) => setUserData(prev => ({...prev, phone: e.target.value}))} className='bg-gray-100 max-w-52' type="email" value={userData.phone} />
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-2.5 mt-3 text-gray-700'>
      ...
      <div className='mt-10 '>
        {
          isEdit ?
            <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all' onClick={updateUserProfileData}>Save Changes</button>
