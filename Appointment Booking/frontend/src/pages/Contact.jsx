  ...
  return (
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-10 justify-center mb-28 text-sm'>
        <img className='w-full md:max-w-[360px]' src={assets.contact_image} alt="We are here to help you out!!" />
        <div className='flex flex-col justify-center items-start gap-6'>
          <p className='font-semibold text-lg text-gray-600'>OUR OFFICE</p>
          <p className='text-gray-500'>Prateek Wisteria, Near Metro Station <br /> Noida, Uttar Pradesh, India</p>
          <p className='text-gray-500'>Tel: (000) 000-0000 <br /> Email: harshgautam333@gmail.com</p>
